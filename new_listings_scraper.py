...
def get_last_coin():
    ...
    latest_announcement = requests.get(f'https://www.binance.com/bapi/composite/v1/public/cms/article/catalog/list/query?catalogId=48&pageNo=1&pageSize=15&rnd= {time.time()}')
