...
def mock_announcement_json():
    return {'data': {'catalogs': [
        {'articles': [
            ...
            {'title': 'Binance Futures Will Launch Coin-Margined AXS Perpetual Contracts with Up to 20X Leverage',
             'releaseDate': 1641868441223},
            {'title': 'Binance Will List Convex Finance (CVX) and ConstitutionDAO (PEOPLE) in the Innovation Zone',
